...
values((select nvl(max(rno),0)+1 from reviewBoard),'han','P1234','1','안녕하세요~','hsh.jpg','hsh.jpg','5');
...
insert into products(p_id, name, category, price, script, tnImage, dsImage, id)
    values('P1238', '레인보우 마카롱', 'food', 2500, '다양한 색의 쫀득한 마카롱', 'macaron_tn.png', 'macaron_ds.png', 'happy77');
insert into products(p_id, name, category, price, script, tnImage, dsImage, id)
    values('P1239', '수제 레몬청', 'food', 12000, '수제 레몬청입니다.', 'lemonjam_tn.png', 'lemonjam_ds.png', 'happy77');
insert into products(p_id, name, category, price, script, tnImage, dsImage, id)
    values('P1240', '드라이 플라워', 'interior', 9900, '시들지 않아요.', 'dryflower_tn.png', 'dryflower_ds.png', 'hong');
insert into products(p_id, name, category, price, script, tnImage, dsImage, id)
    values('P1241', '수제 캔들', 'interior', 11000, '예쁘고 향기로운 수제 캔들', 'candle_tn.png', 'candle_ds.png', 'chanju');
insert into products(p_id, name, category, price, script, tnImage, dsImage, id)
    values('P1242', '레인보우 마카롱', 'food', 2500, '다양한 색의 쫀득한 마카롱', 'macaron_tn.png', 'macaron_ds.png', 'happy77');
insert into products(p_id, name, category, price, script, tnImage, dsImage, id)
    values('P1243', '수제 레몬청', 'food', 12000, '수제 레몬청입니다.', 'lemonjam_tn.png', 'lemonjam_ds.png', 'happy77');
insert into products(p_id, name, category, price, script, tnImage, dsImage, id)
    values('P1244', '드라이 플라워', 'interior', 9900, '시들지 않아요.', 'dryflower_tn.png', 'dryflower_ds.png', 'hong');
insert into products(p_id, name, category, price, script, tnImage, dsImage, id)
    values('P1245', '수제 캔들', 'interior', 11000, '예쁘고 향기로운 수제 캔들', 'candle_tn.png', 'candle_ds.png', 'chanju');
